...
@app.route('/process_steps', methods=['GET'])
def process_steps():
    # process nav bar page
    return render_template('process_steps.html')
######within this box

@app.route('/index2', methods=['GET'])        #changed from '/' to '/index2'
def index2():
    # Main page
